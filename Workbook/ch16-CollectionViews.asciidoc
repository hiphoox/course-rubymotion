...
We need a CollectionViewCell, for this propose we can use a nib file, open your Xcode and in the menu select file>new>file select user interface and choose the empty template then click on next and chose iPhone family give the name "PhotoCollectionCellView" to the file and save it to your resources folder of your application. 
