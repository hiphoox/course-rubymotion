...
The **textFieldShouldReturn** method is called when the user selects the **return** button in the keyboard. Now if you run the app the keyboard should disappear
