...
The first step is adding the images of the clouds, please copy them from **resources/images** folder into the resources folder of the app.
...
For the next step please copy the **bgMoon.png** from the **resources/images** folder into our application resources folder.
...
Challenges
----------
. In the **resources/images** folder are a couple of star images, the challenge is make a animation with them moving from top to bottom, only when the moon is rising. And remove them with another animation when the sun is appears
